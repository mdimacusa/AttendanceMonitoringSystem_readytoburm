...
Public Class EventRecordReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AttendanceManagementSystem.EventRecordReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_ProcessedBy() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedEventRecordReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EventRecordReport = New EventRecordReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
